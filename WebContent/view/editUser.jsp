	...
	<div class= "container-fluid" style="padding: 0;">
         <div class= "row">
			...
			<div class ="col-sm-10">
               ...
               <p><br></p>
               <h2>Sửa đổi thông tin Users</h2>
               <p><br></p>
     			<form action="<%=request.getContextPath()%>/editUser" method="post">
     					<label> Tên đầy đủ: </label>
      					 <input type="text" name="fullname" value="${user.fullName}" disabled="disabled"><br>
       					<label> Tên Đăng nhập: </label>
      					 <input type="text" name="username" value="${user.name}" disabled="disabled"><br>
      					  <label> Mật khẩu: </label>
       					 <input type="text" name="password" value="${user.pass}" disabled="disabled"> <br>
       					 <label> Email: </label>
      					 <input type="text" name="email" value="${user.email}" disabled="disabled"><br>
