		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu">
					<a class="dropdown-item bg-light" href="weddingPageUser">Hoa cưới</a> <a
						class="dropdown-item bg-light" href="wreathPageUser">Hoa viếng</a> <a
...
<div class="row">
	...
	<div class="container">
		<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Danh sách kết quả tìm kiếm</li>
		</ul>
	</div>
	<div class="card-deck">
					...
					<div class="col-md-3">
						<div class="card">
							...
							<div class="card-body">
								...
								<a href="shoppingCart?id=${flower.id}  " class="btn btn-warning">Mua ngay</a>
								<p>
							</div>
						</div>
					</div>
