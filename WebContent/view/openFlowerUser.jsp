...
<body>
	<nav class="navbar navbar-expand-sm navbar-dark bg-success ">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item "><a class="nav-link bg-success " href="web"
	...
	<div class ="container">
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="open">Trang chủ</a></li>
					<li class="breadcrumb-item active" aria-current="page">Dịch vụ</li>
					<li class="breadcrumb-item active" aria-current="page">Hoa khai trương</li>
				</ul>
				</div>
	<div class="card-deck">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<p class="card-text">${flower.price} VNĐ</p>
									<a href="shoppingCart?action=buy&id=${flower.id}  " class="btn btn-primary" ">Mua ngay</a>
							</div>
						</div>
					</div>
				</c:forEach>
