			...
			<div class="row">
				...
				<div class="col-sm-10">
					...
					<p> Thêm sản phẩm tại đây</p>
						<a class="nav-link" href="createFlower" target="_self">Thêm sản phẩm</a>
					<p><br> </p>
					<div class="content" style="text-align: center">
						...
						<p><br>/<p>
						<h3>Bảng sản phẩm hoa sinh nhật</h3>
						<div class="table">
							...
							<nav aria-label="Search results pages" class="pana">
								<ul class="pagination">
									...
									<li class="page-item">
										<a class="page-link" href="productManagement">1</a>
									</li>
									<li class="page-item">
										<a class="page-link" href="productManagement2">2</a>
									</li>
									<li class="page-item">
										<a class="page-link" href="productManagement3">3</a>
									</li>
									<li class="page-item">
										<a class="page-link" href="productManagement4">4</a>
									</li>
								</ul>
							</nav>
						</div>
