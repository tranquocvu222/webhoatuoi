...
<body>
	...
	<div class="container">
		<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Hoa viếng</li>
		</ul>
	</div>
	<div class="card-deck">
				...
				<c:forEach items="${flowers}" var="flower">
					<div class="col-md-3">
						<div class="card">
							...
							<a href="login" onclick="return confirm('Bạn cần đăng nhập để thực hiện thao tác này?')  " class="btn btn-warning" ">Mua ngay</a>
							</div>
						</div>
					</div>
				</c:forEach>
