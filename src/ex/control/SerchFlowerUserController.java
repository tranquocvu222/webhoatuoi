...
/**
 * Servlet implementation class SerchFlowerUserController
 */
@WebServlet("/searchFlowerUser")
public class SerchFlowerUserController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SerchFlowerUserController() {
        super();
